...
\begin{itemize}
    \item \textbf{Schachtauffahrung:} $2 \times 3.000\,\text{m}$ Vortrieb ($32.000\,\text{€/m}$): $192{,}0\,\text{Mio. €}$.
    \item \textbf{Felsausbau und Glättung:} Spritzbetonschale und Felsanker: $18{,}0\,\text{Mio. €}$.
    \item \textbf{Portalanlagen \& Geotechnik:} Diffusoren, Schutzbauten: $12{,}0\,\text{Mio. €}$.
    \item \textbf{Wärmetauscher und Turbinen:} $14{,}5\,\text{Mio. €}$.
    \item \textbf{Brutto-Investition Schacht ($\text{CapEx}_{\text{sys}}$):} $236{,}5\,\text{Mio. €}$.
\end{itemize}

Dem gegenüber steht der Wegfall klassischer Chiller, Kühltürme und Wasseraufbereitungsanlagen ($\text{CapEx}_{\text{konv}} \approx 38{,}5\,\text{Mio. €}$), was eine Netto-Mehrinvestition von $\Delta\text{CapEx} = 198{,}0\,\text{Mio. €}$ ergibt.

\subsection{Betriebskosteneinsparung ($\Delta\text{OPEX}$)}
Bei Standardpreisen von $k_{\text{el}} = 0{,}10\,\text{€/kWh}$ und $k_{\text{w}} = 2{,}50\,\text{€/m}^3$ errechnen sich die jährlichen OPEX-Vorteile zu:
\begin{align}
\Delta C_{\text{p-klima}} &= 4.000\,\text{kW} \cdot 8.760\,\text{h} \cdot 0{,}10\,\text{€/kWh} = 3{,}50\,\text{Mio. €/a} \\
R_{\text{gen}} &= 2.250\,\text{kW} \cdot 8.760\,\text{h} \cdot 0{,}10\,\text{€/kWh} = 1{,}97\,\text{Mio. €/a} \\
\Delta C_{\text{wasser}} &= 1.576.800\,\text{m}^3 \cdot 2{,}50\,\text{€/m}^3 = 3{,}94\,\text{Mio. €/a} \\
\Delta C_{\text{maint}} &\approx 0{,}75\,\text{Mio. €/a}
\end{align}
Daraus folgt eine jährliche Gesamtentlastung von $\mathbf{\Delta\text{OPEX} \approx 10{,}17\,\text{Mio. €/a}}$.
...
\textbf{Szenario} & \textbf{$k_{\text{el}}$} & \textbf{$k_{\text{w}}$} & \textbf{$\Delta\text{OPEX}$} & \textbf{$\text{NPV}_{50}$} \\
 & \textbf{[€/kWh]} & \textbf{[€/m³]} & \textbf{[Mio. €/a]} & \textbf{[Mio. €]} \\
\midrule
